...
public class InventoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        itemNameText=(EditText)view.findViewById(R.id.txtInventoryItem);
        submitButton=(Button)view.findViewById(R.id.btnSubmit);
        submitButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String inventoryItem=itemNameText.getText().toString();
                Toast.makeText(InventoryFragment.this.getActivity(), "Inventory Item:"+inventoryItem, Toast.LENGTH_SHORT).show();
            }
        });
